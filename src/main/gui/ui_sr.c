...
void sr_anim_set_background_green(void)
{
    lv_obj_set_style_bg_color(lv_scr_act(), lv_color_make(150, 255, 180), LV_STATE_DEFAULT);
}
void sr_anim_set_background_red(void)
{
    lv_obj_set_style_bg_color(lv_scr_act(), lv_color_make(255, 150, 150), LV_STATE_DEFAULT);
}
